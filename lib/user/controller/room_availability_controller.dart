...
>((ref, arg) async {
  ...
  final selectedTimeslotsNumbers = selectedTimeslots.map((item) => item['number']);
  ...
  int startHour = selectedTimeslots[0]['start_hour'];
  int startMin = selectedTimeslots[0]['start_min'];
  ...
  final books =
      await FirebaseFirestore.instance
          ...
          .where("timeslots", arrayContainsAny: selectedTimeslotsNumbers)
          .get();


  return books.docs.isEmpty;
});
